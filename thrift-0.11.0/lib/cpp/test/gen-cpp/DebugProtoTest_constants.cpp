...
DebugProtoTestConstants::DebugProtoTestConstants() {
  ...
  COMPACT_TEST.empty_struct_field = tmp636;
  COMPACT_TEST.__isset.empty_struct_field = true;
  std::vector<int8_t>  tmp637;
  tmp637.push_back(-127);
  tmp637.push_back(-1);
  tmp637.push_back(0);
  tmp637.push_back(1);
  tmp637.push_back(127);

  COMPACT_TEST.byte_list = tmp637;
  COMPACT_TEST.__isset.byte_list = true;
  std::vector<int16_t>  tmp638;
  tmp638.push_back(-1);
  tmp638.push_back(0);
  tmp638.push_back(1);
  tmp638.push_back(32767);

  COMPACT_TEST.i16_list = tmp638;
  COMPACT_TEST.__isset.i16_list = true;
  std::vector<int32_t>  tmp639;
  tmp639.push_back(-1);
  tmp639.push_back(0);
  tmp639.push_back(255);
  tmp639.push_back(65535);
  tmp639.push_back(16777215);
  tmp639.push_back(2147483647);

  COMPACT_TEST.i32_list = tmp639;
  COMPACT_TEST.__isset.i32_list = true;
  std::vector<int64_t>  tmp640;
  tmp640.push_back(-1LL);
  tmp640.push_back(0LL);
  tmp640.push_back(255LL);
  tmp640.push_back(65535LL);
  tmp640.push_back(16777215LL);
  tmp640.push_back(4294967295LL);
  tmp640.push_back(1099511627775LL);
  tmp640.push_back(281474976710655LL);
  tmp640.push_back(72057594037927935LL);
  tmp640.push_back(9223372036854775807LL);

  COMPACT_TEST.i64_list = tmp640;
  COMPACT_TEST.__isset.i64_list = true;
  std::vector<double>  tmp641;
  tmp641.push_back(0.1);
  tmp641.push_back(0.2);
  tmp641.push_back(0.3);

  COMPACT_TEST.double_list = tmp641;
  COMPACT_TEST.__isset.double_list = true;
  std::vector<std::string>  tmp642;
  tmp642.push_back("first");
  tmp642.push_back("second");
  tmp642.push_back("third");

  COMPACT_TEST.string_list = tmp642;
  COMPACT_TEST.__isset.string_list = true;
  std::vector<bool>  tmp643;
  tmp643.push_back(true);
  tmp643.push_back(true);
  tmp643.push_back(true);
  tmp643.push_back(false);
  tmp643.push_back(false);
  tmp643.push_back(false);

  COMPACT_TEST.boolean_list = tmp643;
  COMPACT_TEST.__isset.boolean_list = true;
  std::vector<Empty>  tmp644;
  Empty tmp645;

  tmp644.push_back(tmp645);
  Empty tmp646;

  tmp644.push_back(tmp646);

  COMPACT_TEST.struct_list = tmp644;
  COMPACT_TEST.__isset.struct_list = true;
  std::set<int8_t>  tmp647;
  tmp647.insert(-127);
  tmp647.insert(-1);
  tmp647.insert(0);
  tmp647.insert(1);
  ...
  COMPACT_TEST.byte_set = tmp647;
  COMPACT_TEST.__isset.byte_set = true;
  std::set<int16_t>  tmp648;
  tmp648.insert(-1);
  tmp648.insert(0);
  tmp648.insert(1);
  tmp648.insert(32767);

  COMPACT_TEST.i16_set = tmp648;
  COMPACT_TEST.__isset.i16_set = true;
  std::set<int32_t>  tmp649;
  tmp649.insert(1);
  tmp649.insert(2);
  tmp649.insert(3);

  COMPACT_TEST.i32_set = tmp649;
  COMPACT_TEST.__isset.i32_set = true;
  std::set<int64_t>  tmp650;
  tmp650.insert(-1LL);
  tmp650.insert(0LL);
  tmp650.insert(255LL);
  tmp650.insert(65535LL);
  tmp650.insert(16777215LL);
  tmp650.insert(4294967295LL);
  tmp650.insert(1099511627775LL);
  tmp650.insert(281474976710655LL);
  tmp650.insert(72057594037927935LL);
  tmp650.insert(9223372036854775807LL);

  COMPACT_TEST.i64_set = tmp650;
  COMPACT_TEST.__isset.i64_set = true;
  std::set<double>  tmp651;
  tmp651.insert(0.1);
  tmp651.insert(0.2);
  tmp651.insert(0.3);

  COMPACT_TEST.double_set = tmp651;
  COMPACT_TEST.__isset.double_set = true;
  std::set<std::string>  tmp652;
  tmp652.insert("first");
  tmp652.insert("second");
  tmp652.insert("third");

  COMPACT_TEST.string_set = tmp652;
  COMPACT_TEST.__isset.string_set = true;
  std::set<bool>  tmp653;
  tmp653.insert(true);
  tmp653.insert(false);

  COMPACT_TEST.boolean_set = tmp653;
  COMPACT_TEST.__isset.boolean_set = true;
  std::set<Empty>  tmp654;
  Empty tmp655;

  tmp654.insert(tmp655);

  COMPACT_TEST.struct_set = tmp654;
  COMPACT_TEST.__isset.struct_set = true;
  std::map<int8_t, int8_t>  tmp656;
  tmp656.insert(std::make_pair(1, 2));

  COMPACT_TEST.byte_byte_map = tmp656;
  COMPACT_TEST.__isset.byte_byte_map = true;
  std::map<int16_t, int8_t>  tmp657;
  tmp657.insert(std::make_pair(1, 1));
  tmp657.insert(std::make_pair(-1, 1));
  tmp657.insert(std::make_pair(32767, 1));

  COMPACT_TEST.i16_byte_map = tmp657;
  COMPACT_TEST.__isset.i16_byte_map = true;
  std::map<int32_t, int8_t>  tmp658;
  tmp658.insert(std::make_pair(1, 1));
  tmp658.insert(std::make_pair(-1, 1));
  tmp658.insert(std::make_pair(2147483647, 1));

  COMPACT_TEST.i32_byte_map = tmp658;
  COMPACT_TEST.__isset.i32_byte_map = true;
  std::map<int64_t, int8_t>  tmp659;
  tmp659.insert(std::make_pair(0LL, 1));
  tmp659.insert(std::make_pair(1LL, 1));
  tmp659.insert(std::make_pair(-1LL, 1));
  tmp659.insert(std::make_pair(9223372036854775807LL, 1));

  COMPACT_TEST.i64_byte_map = tmp659;
  COMPACT_TEST.__isset.i64_byte_map = true;
  std::map<double, int8_t>  tmp660;
  tmp660.insert(std::make_pair(-1.1, 1));
  tmp660.insert(std::make_pair(1.1, 1));

  COMPACT_TEST.double_byte_map = tmp660;
  COMPACT_TEST.__isset.double_byte_map = true;
  std::map<std::string, int8_t>  tmp661;
  tmp661.insert(std::make_pair("first", 1));
  tmp661.insert(std::make_pair("second", 2));
  tmp661.insert(std::make_pair("third", 3));
  tmp661.insert(std::make_pair("", 0));

  COMPACT_TEST.string_byte_map = tmp661;
